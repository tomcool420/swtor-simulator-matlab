...
gra=struct('c',1.502,'Sm',0.130,'Sx',0.170,'Am',0.000,'Sh',3185,...
         ...
         'ctype',2,'ct',1.5,'mult',1.15,'CD',0.000000,...
...
dem=struct('c',2.220,'Sm',0.202,'Sx',0.242,'Am',0.000,'Sh',3185,...
         ...
         'ctype',1,'ct',0.0,'mult',1.15,'CD',15.000000,...
         'raidAOE',0,'raidIE',0,'raidKEFT',1);
vor=struct('c',2.020,'Sm',0.202,'Sx',0.202,'Am',0.340,'Sh',3185,...
         ...
         'cb',0.05,'sb',0.3,'s30',0.0,'dmg_type',1,'base_acc',1.0,'raid_mult',1.0,...
         'ctype',0,'ct',0.0,'mult',1.1,'CD',18.000000,...
         'raidAOE',0,'raidIE',0,'raidKEFT',1);
...
ele=struct('c',0.290,'Sm',0.029,'Sx',0.029,'Am',0.000,'Sh',3185,...
         ...
         'ctype',4,'ct',0.0,'mult',1.05,'CD',90.000000,...
         'raidAOE',0,'raidIE',0,'raidKEFT',1);
ham=struct('c',1.000,'Sm',0.000,'Sx',0.000,'Am',0.000,'Sh',3185,...
         ...
         'raidAOE',0,'raidIE',0,'raidKEFT',1);
bol=struct('c',1.048,'Sm',0.105,'Sx',0.105,'Am',-0.300,'Sh',3185,...
         'w',1,'long_id','abl.test.modny.boltstorm_test','id','boltstorm_test','name','',...
         'cb',0.05,'sb',0.0,'s30',0.0,'dmg_type',1,'base_acc',1.0,'raid_mult',1.0,...
         'ctype',0,'ct',0.0,'mult',1.0,'CD',0.000000,...
         'raidAOE',0,'raidIE',0,'raidKEFT',1);
abilities=struct('gra',gra,'dem',dem,'ful',ful,'ham',ham,'ele',ele,'vor',vor,'hig',hig,'bol',bol);
...
procs=struct('FR',struct('LastProc',-1,'Dur',6,'CD',20),...
             ...
             'CB',struct('LastProc',-1,'Dur',15,'CD',0,'Charges',0),...
             'CoF',struct('LastProc',-1,'Dur',15,'CD',8,'Available',0),...
             'TL',struct('LastProc',-1,'Dur',15,'CD',0));
